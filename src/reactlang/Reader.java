...
public class Reader {
	...
	public Program parse(String programText) {
		...
		ReactLangParser p = getParser(new org.antlr.v4.runtime.CommonTokenStream(l));
		Program program = p.program().ast;
		return program;
	}
	
	protected Lexer getLexer(org.antlr.v4.runtime.ANTLRInputStream s) {
		return new ReactLangLexer(s);
	}
	
	protected ReactLangParser getParser(org.antlr.v4.runtime.CommonTokenStream s) {
		return new ReactLangParser(s);
	}
